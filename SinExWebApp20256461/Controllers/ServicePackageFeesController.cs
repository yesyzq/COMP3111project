...
namespace SinExWebApp20256461.Controllers
{
    public class ServicePackageFeesController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.HKD = db.Currencies.FirstOrDefault(s => s.CurrencyCode == "HKD").ExchangeRate;
            ViewBag.MOP = db.Currencies.FirstOrDefault(s => s.CurrencyCode == "MOP").ExchangeRate;
            ViewBag.TWD = db.Currencies.FirstOrDefault(s => s.CurrencyCode == "TWD").ExchangeRate;
